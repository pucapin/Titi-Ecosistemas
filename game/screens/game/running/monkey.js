...
export function initMonkey(game) {
  return new Promise((resolve, reject) => {
    ...
    monkey.images.running1.src = "https://cmyrktpbeqcoodpebbuz.supabase.co/storage/v1/object/public/Assets/running1.svg";

    monkey.images.running2 = new Image();
    monkey.images.running2.onload = onLoad;
    monkey.images.running2.onerror = onError;
    monkey.images.running2.src = "https://cmyrktpbeqcoodpebbuz.supabase.co/storage/v1/object/public/Assets/running2.svg";

    monkey.images.jumping1 = new Image();
    monkey.images.jumping1.onload = onLoad;
    monkey.images.jumping1.onerror = onError;
    monkey.images.jumping1.src = "https://cmyrktpbeqcoodpebbuz.supabase.co/storage/v1/object/public/Assets/jumping1.svg";

    monkey.images.jumping2 = new Image();
    monkey.images.jumping2.onload = onLoad;
    monkey.images.jumping2.onerror = onError;
    monkey.images.jumping2.src = "https://cmyrktpbeqcoodpebbuz.supabase.co/storage/v1/object/public/Assets/jumping2.svg";
  });
}
